        ...
        for idx,buildings in enumerate(build_list):
            ...
            if buildings == 0:
                ...
                for floor in range(4):
                    ...
                    # 레고 블럭 좌표로 이동
                    movel(block_for_construction, vel = VELOCITY, acc = ACC, radius=20 )
                    mwait(0.5)
                    ...
                    # 레고블럭 쌓을 위치로 이동
                    movel(block_to_place, vel = VELOCITY, acc = ACC, radius=20)
                ...
                for fl, floor_plan in enumerate(_3type_building):
                    ...
                    for block_count, block_type in enumerate(floor_plan):
                        ...
                        movel(final_placement_pose, vel=VELOCITY, acc=ACC,radius=20)
